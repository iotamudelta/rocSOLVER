...
extern "C" ROCSOLVER_EXPORT rocblas_status rocsolver_sgetrs(
    rocsolver_handle handle, rocblas_operation trans, rocblas_int n,
    rocblas_int nrhs, const float *A, rocblas_int lda, const rocblas_int *ipiv,
...
extern "C" ROCSOLVER_EXPORT rocblas_status rocsolver_dgetrs(
    rocsolver_handle handle, rocblas_operation trans, rocblas_int n,
    rocblas_int nrhs, const double *A, rocblas_int lda, const rocblas_int *ipiv,
